...
def packingCertificateNat78VertexGroup40 : List Erdos302.PackingTermNat := [
  { configurationId := 12707, snapshot := { maximum := 194, demand := 12, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194] },
    numerator := 70070878402325238900, denominator := 193242360659659570711, units := 0 },
...
def packingCertificateNat78VertexChunk10 : List Erdos302.PackingTermNat :=
  packingCertificateNat78VertexGroup40
