...
theorem packingCertificateNat270_linkChunk5 :
    packingCertificateNat270VertexChunk5.all (fun t => decide (t.configurationId < 14691 ∧ t.snapshot.maximum.val < 719 ∧ t.LinkOK concreteConfigurationAt ∧ 0 < t.numerator ∧ 0 < t.denominator)) = true := by
