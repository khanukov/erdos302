...
def packingCertificateNat164VertexGroup72 : List Erdos302.PackingTermNat := [
  { configurationId := 6983, snapshot := { maximum := 443, demand := 1, support := [384, 439, 443] },
    numerator := 69832795228, denominator := 229321370781, units := 0 },
  { configurationId := 7046, snapshot := { maximum := 445, demand := 1, support := [386, 442, 445] },
    numerator := 1023427924659, denominator := 1715663588806, units := 0 },
  ...
  { configurationId := 12715, snapshot := { maximum := 396, demand := 20, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303, 319, 337, 361, 396] },
    numerator := 5010974900820, denominator := 5699060733113, units := 0 },
...
def packingCertificateNat164VertexGroup73 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13031, snapshot := { maximum := 437, demand := 21, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181, 190, 193, 209, 214, 220, 232, 245, 263, 274, 289, 302, 321, 346, 380, 437] },
    numerator := 1508954588778, denominator := 2386640932943, units := 0 },
]

def packingCertificateNat164VertexGroup74 : List Erdos302.PackingTermNat := [
  { configurationId := 13047, snapshot := { maximum := 446, demand := 16, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417, 428, 446] },
    numerator := 8493177798, denominator := 8493384103, units := 0 },
  { configurationId := 13069, snapshot := { maximum := 426, demand := 17, support := [59, 75, 88, 98, 106, 116, 123, 136, 147, 157, 162, 166, 181, 184, 193, 205, 209, 214, 222, 232, 235, 245, 258, 263, 276, 289, 292, 302, 311, 315, 321, 334, 346, 350, 368, 372, 380, 393, 407, 426] },
...
def packingCertificateNat164VertexGroup75 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 14287, snapshot := { maximum := 422, demand := 17, support := [58, 74, 86, 96, 105, 113, 120, 134, 145, 154, 160, 163, 178, 181, 190, 202, 207, 210, 217, 228, 232, 242, 254, 260, 271, 284, 289, 298, 306, 312, 317, 330, 341, 346, 363, 369, 375, 388, 404, 422] },
    numerator := 20761101284, denominator := 76440456927, units := 0 },
...
def packingCertificateNat164VertexChunk18 : List Erdos302.PackingTermNat :=
  packingCertificateNat164VertexGroup72 ++ packingCertificateNat164VertexGroup73 ++ packingCertificateNat164VertexGroup74 ++ packingCertificateNat164VertexGroup75
