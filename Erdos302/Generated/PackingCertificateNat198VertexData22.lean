...
def packingCertificateNat198VertexGroup88 : List Erdos302.PackingTermNat := [
  { configurationId := 9094, snapshot := { maximum := 537, demand := 1, support := [483, 528, 537] },
    numerator := 1558535745, denominator := 2353052099, units := 0 },
  ...
  { configurationId := 12716, snapshot := { maximum := 454, demand := 21, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303, 319, 337, 361, 396, 454] },
    numerator := 511330625, denominator := 716146291, units := 0 },
...
def packingCertificateNat198VertexGroup89 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13049, snapshot := { maximum := 485, demand := 18, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417, 428, 446, 463, 474, 485] },
    numerator := 9551656075, denominator := 11151420817, units := 0 },
...
def packingCertificateNat198VertexGroup90 : List Erdos302.PackingTermNat := [
  { configurationId := 13199, snapshot := { maximum := 523, demand := 21, support := [34, 46, 55, 62, 69, 75, 81, 90, 100, 106, 112, 114, 127, 130, 138, 147, 152, 155, 162, 170, 173, 182, 193, 200, 209, 220, 224, 233, 241, 245, 252, 263, 274, 279, 297, 302, 309, 321, 336, 356, 366, 380, 395, 414, 437, 471, 523] },
    numerator := 204532250, denominator := 306919839, units := 0 },
...
def packingCertificateNat198VertexGroup91 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat198VertexChunk22 : List Erdos302.PackingTermNat :=
  packingCertificateNat198VertexGroup88 ++ packingCertificateNat198VertexGroup89 ++ packingCertificateNat198VertexGroup90 ++ packingCertificateNat198VertexGroup91
