...
def packingCertificateNat176VertexGroup76 : List Erdos302.PackingTermNat := [
  { configurationId := 7253, snapshot := { maximum := 471, demand := 1, support := [403, 451, 471] },
    numerator := 166250075868308740, denominator := 656396726721546359, units := 0 },
  { configurationId := 7402, snapshot := { maximum := 459, demand := 1, support := [401, 457, 459] },
    numerator := 33779895893560740, denominator := 229838208044779603, units := 0 },
  { configurationId := 7469, snapshot := { maximum := 471, demand := 1, support := [407, 460, 471] },
    numerator := 510956408474028, denominator := 12584801016861131, units := 0 },
  { configurationId := 7517, snapshot := { maximum := 472, demand := 1, support := [408, 462, 472] },
    numerator := 32833680322312540, denominator := 61599289187793957, units := 0 },
  { configurationId := 7518, snapshot := { maximum := 475, demand := 1, support := [410, 462, 475] },
    numerator := 3417128506166795, denominator := 12584801016861131, units := 0 },
]

def packingCertificateNat176VertexGroup77 : List Erdos302.PackingTermNat := [
  { configurationId := 7569, snapshot := { maximum := 468, demand := 1, support := [409, 464, 468] },
    numerator := 29900412051443120, denominator := 68222868670352447, units := 0 },
  { configurationId := 7807, snapshot := { maximum := 476, demand := 1, support := [418, 474, 476] },
    numerator := 1189220933864215, denominator := 1987073844767547, units := 0 },
  ...
  { configurationId := 12716, snapshot := { maximum := 454, demand := 21, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303, 319, 337, 361, 396, 454] },
    numerator := 83077727155591960, denominator := 90743038911051313, units := 0 },
...
def packingCertificateNat176VertexGroup78 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat176VertexGroup79 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13048, snapshot := { maximum := 463, demand := 17, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417, 428, 446, 463] },
    numerator := 662350899873740, denominator := 662357948255849, units := 0 },
...
def packingCertificateNat176VertexChunk19 : List Erdos302.PackingTermNat :=
  packingCertificateNat176VertexGroup76 ++ packingCertificateNat176VertexGroup77 ++ packingCertificateNat176VertexGroup78 ++ packingCertificateNat176VertexGroup79
