...
def packingCertificateNat209VertexGroup92 : List Erdos302.PackingTermNat := [
  { configurationId := 9581, snapshot := { maximum := 562, demand := 1, support := [507, 549, 562] },
    numerator := 923276322540, denominator := 349306350764747, units := 0 },
  ...
  { configurationId := 9780, snapshot := { maximum := 560, demand := 1, support := [511, 557, 560] },
    numerator := 8161762691253600, denominator := 13515232065051863, units := 0 },
...
def packingCertificateNat209VertexGroup93 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat209VertexGroup94 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat209VertexGroup95 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat209VertexChunk23 : List Erdos302.PackingTermNat :=
  packingCertificateNat209VertexGroup92 ++ packingCertificateNat209VertexGroup93 ++ packingCertificateNat209VertexGroup94 ++ packingCertificateNat209VertexGroup95
