...
def packingCertificateNat269VertexGroup96 : List Erdos302.PackingTermNat := [
  { configurationId := 12269, snapshot := { maximum := 691, demand := 1, support := [664, 678, 691] },
...
def packingCertificateNat269VertexGroup97 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat269VertexGroup98 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 14669, snapshot := { maximum := 708, demand := 21, support := [321, 356, 380, 398, 414, 426, 437, 455, 471, 483, 487, 492, 509, 513, 523, 534, 537, 542, 549, 556, 561, 569, 578, 582, 592, 598, 602, 609, 613, 616, 620, 628, 632, 635, 644, 647, 650, 656, 661, 669, 673, 677, 682, 688, 693, 700, 708] },
    numerator := 1651270772130, denominator := 1651276632127, units := 0 },
]

def packingCertificateNat269VertexGroup99 : List Erdos302.PackingTermNat := [
  { configurationId := 14689, snapshot := { maximum := 717, demand := 20, support := [515, 545, 563, 577, 588, 597, 604, 615, 625, 631, 634, 637, 646, 649, 654, 659, 660, 663, 667, 670, 672, 676, 680, 681, 686, 689, 690, 692, 694, 695, 696, 699, 701, 702, 704, 705, 706, 707, 709, 711, 712, 713, 714, 715, 716, 717] },
    numerator := 1651270772130, denominator := 1651276632127, units := 0 },
]

def packingCertificateNat269VertexChunk24 : List Erdos302.PackingTermNat :=
  packingCertificateNat269VertexGroup96 ++ packingCertificateNat269VertexGroup97 ++ packingCertificateNat269VertexGroup98 ++ packingCertificateNat269VertexGroup99
