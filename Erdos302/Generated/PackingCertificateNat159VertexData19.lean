...
def packingCertificateNat159VertexGroup76 : List Erdos302.PackingTermNat := [
  { configurationId := 6386, snapshot := { maximum := 424, demand := 1, support := [360, 414, 424] },
    numerator := 445833619315, denominator := 2041818548664, units := 0 },
  { configurationId := 6584, snapshot := { maximum := 428, demand := 1, support := [367, 422, 428] },
    numerator := 1483477663435, denominator := 4210553414219, units := 0 },
  { configurationId := 6616, snapshot := { maximum := 427, demand := 1, support := [367, 423, 427] },
    numerator := 163177894035, denominator := 1871667002942, units := 0 },
  ...
  { configurationId := 12715, snapshot := { maximum := 396, demand := 20, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303, 319, 337, 361, 396] },
    numerator := 6443434790100, denominator := 6879980123333, units := 0 },
]

def packingCertificateNat159VertexGroup77 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13046, snapshot := { maximum := 417, demand := 15, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417] },
    numerator := 6681925558305, denominator := 6688908305596, units := 0 },
]

def packingCertificateNat159VertexGroup78 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat159VertexGroup79 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat159VertexChunk19 : List Erdos302.PackingTermNat :=
  packingCertificateNat159VertexGroup76 ++ packingCertificateNat159VertexGroup77 ++ packingCertificateNat159VertexGroup78 ++ packingCertificateNat159VertexGroup79
