...
def packingCertificateNat82VertexGroup40 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 12694, snapshot := { maximum := 202, demand := 20, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113, 120, 129, 140, 154, 172, 202] },
    numerator := 1513867512993, denominator := 18067408797529, units := 0 },
  { configurationId := 12709, snapshot := { maximum := 230, demand := 14, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230] },
    numerator := 2562970931088, denominator := 4963573845475, units := 0 },
...
def packingCertificateNat82VertexGroup41 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat82VertexChunk10 : List Erdos302.PackingTermNat :=
  packingCertificateNat82VertexGroup40 ++ packingCertificateNat82VertexGroup41
