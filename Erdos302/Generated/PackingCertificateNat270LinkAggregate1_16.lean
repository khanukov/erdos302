...
theorem packingCertificateNat270LinkSegment1_16_ok : packingCertificateNat270LinkSegment1_16.all (fun c => c.all (fun t => decide (t.configurationId < 14691 ∧ t.snapshot.maximum.val < 719 ∧ t.LinkOK concreteConfigurationAt ∧ 0 < t.numerator ∧ 0 < t.denominator))) = true := by
