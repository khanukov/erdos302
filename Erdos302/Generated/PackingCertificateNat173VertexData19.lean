...
def packingCertificateNat173VertexGroup76 : List Erdos302.PackingTermNat := [
  { configurationId := 12716, snapshot := { maximum := 454, demand := 21, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303, 319, 337, 361, 396, 454] },
    numerator := 24728751460, denominator := 26183668953, units := 0 },
...
def packingCertificateNat173VertexGroup77 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13031, snapshot := { maximum := 437, demand := 21, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181, 190, 193, 209, 214, 220, 232, 245, 263, 274, 289, 302, 321, 346, 380, 437] },
    numerator := 42392145360, denominator := 148374124067, units := 0 },
  { configurationId := 13048, snapshot := { maximum := 463, demand := 17, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417, 428, 446, 463] },
    numerator := 148372508760, denominator := 148374124067, units := 0 },
...
def packingCertificateNat173VertexGroup78 : List Erdos302.PackingTermNat := [
  { configurationId := 13197, snapshot := { maximum := 437, demand := 19, support := [34, 46, 55, 62, 69, 75, 81, 90, 100, 106, 112, 114, 127, 130, 138, 147, 152, 155, 162, 170, 173, 182, 193, 200, 209, 220, 224, 233, 241, 245, 252, 263, 274, 279, 297, 302, 309, 321, 336, 356, 366, 380, 395, 414, 437] },
    numerator := 52107012005, denominator := 445122372201, units := 0 },
  ...
  { configurationId := 14288, snapshot := { maximum := 447, demand := 18, support := [58, 74, 86, 96, 105, 113, 120, 134, 145, 154, 160, 163, 178, 181, 190, 202, 207, 210, 217, 228, 232, 242, 254, 260, 271, 284, 289, 298, 306, 312, 317, 330, 341, 346, 363, 369, 375, 388, 404, 422, 432, 447] },
    numerator := 883169695, denominator := 11413394159, units := 0 },
...
def packingCertificateNat173VertexChunk19 : List Erdos302.PackingTermNat :=
  packingCertificateNat173VertexGroup76 ++ packingCertificateNat173VertexGroup77 ++ packingCertificateNat173VertexGroup78
