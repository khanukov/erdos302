import Erdos302.Generated.BasePrefix.Chunked.Certificate19.Validity0329
...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate19.Compose0329Batch000
open Erdos302.BasePrefixCoverChunk
open Erdos302.Generated.BasePrefix
open Erdos302.Generated.BasePrefix.Chunked.Certificate19

def sources : List (Claim 146) := [Validity0199.steps[12].claim, Validity0223.steps[5].claim, Validity0235.steps[14].claim, Validity0328.steps[27].claim, Validity0328.steps[28].claim, Validity0328.steps[29].claim, Validity0328.steps[30].claim, Validity0328.steps[31].claim]
...
theorem sources_hold : ClaimsHold sources support := by
  ...
  rcases h with rfl | h
  exact Compose0223Root.all_holds ⟨5, by decide⟩
  rcases h with rfl | h
  exact Compose0235Root.all_holds ⟨14, by decide⟩
  rcases h with rfl | h
  exact Compose0328Root.all_holds ⟨27, by decide⟩
  rcases h with rfl | h
  exact Compose0328Root.all_holds ⟨28, by decide⟩
  rcases h with rfl | h
  exact Compose0328Root.all_holds ⟨29, by decide⟩
  rcases h with rfl | h
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate19.Compose0329Batch000
