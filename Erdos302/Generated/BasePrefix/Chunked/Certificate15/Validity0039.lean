...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0039
...
def imports : Array (Claim 146) := #[⟨325239159432283953283897521886127, 9⟩, ⟨325239159432283915847725619368367, 8⟩, ⟨325239150983970858958282237729199, 8⟩, ⟨119698193910064228005319077, 6⟩, ⟨119684026229651267127345583, 5⟩, ⟨119698193910064228002169253, 5⟩, ⟨119698193910064227993782575, 5⟩]

def steps : Array (Step 47 146) := #[
  { claim := ⟨119698193910064228002204079, 6⟩, rule := .branch 15 [(23, .imported 4), (8, .imported 5), (10, .imported 6)] },
  { claim := ⟨3641315222556227606190511, 6⟩, rule := .packing [8, 0, 2, 81, 12, 60, 15] },
  { claim := ⟨119698193910064228005370287, 7⟩, rule := .branch 14 [(8, .imported 3), (9, .local 0), (26, .local 1)] },
  ...
  { claim := ⟨718125071726223194023950059695, 6⟩, rule := .branch 15 [(23, .local 5), (8, .local 6), (10, .local 7)] },
  { claim := ⟨718009014847535686023554046127, 6⟩, rule := .packing [0, 2, 12, 15, 60, 81, 92] },
  { claim := ⟨718125071726223194023953225903, 7⟩, rule := .branch 14 [(8, .local 4), (9, .local 8), (26, .local 9)] },
  { claim := ⟨718125072243020258463972383151, 8⟩, rule := .branch 58 [(33, .local 2), (20, .local 3), (22, .local 10)] },
  { claim := ⟨325239159447632187881403905530287, 9⟩, rule := .branch 70 [(23, .imported 1), (25, .imported 2), (36, .local 11)] },
  ...
  { claim := ⟨325239077089043930977726243068591, 8⟩, rule := .branch 11 [(23, .local 14), (8, .local 15), (7, .local 16)] },
  ...
  { claim := ⟨324521071866332233423376608189359, 8⟩, rule := .branch 11 [(23, .local 18), (8, .local 19), (7, .local 20)] },
  { claim := ⟨325239077089265616165783928363951, 9⟩, rule := .branch 58 [(20, .local 13), (22, .local 17), (33, .local 21)] },
  { claim := ⟨325239159447632297375169845975983, 10⟩, rule := .branch 56 [(23, .imported 0), (19, .local 12), (30, .local 22)] },
  ...
  { claim := ⟨718125071724493815070407841935, 7⟩, rule := .branch 11 [(8, .local 28), (23, .local 29), (7, .local 30)] }
]
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0039
