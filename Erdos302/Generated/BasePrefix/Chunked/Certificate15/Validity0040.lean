...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0040
...
def imports : Array (Claim 146) := #[⟨325239159432282512135320128213903, 9⟩, ⟨325239159431765965865092377768091, 7⟩, ⟨325239077073694506025854734463643, 7⟩, ⟨324521071850982808471505099584411, 7⟩, ⟨325239043390606035917878842399663, 10⟩, ⟨325239159447632297375169845975983, 10⟩, ⟨325239159432282474699148225696143, 8⟩, ⟨325239150983968841348952540633487, 8⟩, ⟨718009015214741188539904727439, 7⟩, ⟨119698192180685274459986319, 7⟩, ⟨718125071724493815070407841935, 7⟩]

def steps : Array (Step 47 146) := #[
  { claim := ⟨718125072241002649134275287439, 8⟩, rule := .branch 67 [(26, .imported 8), (33, .imported 9), (22, .imported 10)] },
  { claim := ⟨325239159447630170272074208434575, 9⟩, rule := .branch 70 [(23, .imported 6), (25, .imported 7), (36, .local 0)] },
  { claim := ⟨325239077089263598556454231268239, 9⟩, rule := .packing [0, 2, 8, 48, 92, 22, 81, 73, 12, 18] },
  { claim := ⟨325239159447630279765840148880271, 10⟩, rule := .branch 56 [(23, .imported 0), (19, .local 1), (30, .local 2)] },
  { claim := ⟨325239159447632297382871259470767, 11⟩, rule := .branch 42 [(26, .imported 4), (15, .imported 5), (20, .local 3)] },
  ...
  { claim := ⟨86740578673078505791533896331, 6⟩, rule := .branch 14 [(8, .local 7), (9, .local 8), (26, .local 9)] },
  { claim := ⟨325239159431765967272458671379083, 7⟩, rule := .branch 85 [(26, .local 5), (29, .local 6), (38, .local 10)] },
  { claim := ⟨325239159431765967307651633410715, 8⟩, rule := .branch 45 [(16, .local 11), (19, .imported 1), (30, .imported 2)] },
  ...
  { claim := ⟨324521154058233690206652704519067, 8⟩, rule := .branch 45 [(19, .local 14), (16, .local 15), (30, .imported 3)] },
  { claim := ⟨325239159432282512170512519820187, 9⟩, rule := .branch 67 [(22, .local 12), (26, .local 13), (33, .local 16)] },
  ...
  { claim := ⟨86740578674231423993312727723, 6⟩, rule := .branch 3 [(4, .local 20), (8, .local 21), (2, .local 22)] },
  { claim := ⟨325239159431767120190660450210475, 7⟩, rule := .branch 99 [(29, .local 18), (33, .local 19), (38, .local 23)] },
  ...
  { claim := ⟨325239159431767118853662900777147, 7⟩, rule := .branch 46 [(16, .local 25), (20, .local 26), (28, .local 27)] },
  { claim := ⟨325239077073695659014425257472699, 7⟩, rule := .packing [1, 48, 92, 81, 108, 12, 4, 60] },
  { claim := ⟨325239159431767120296222156419771, 8⟩, rule := .branch 45 [(16, .local 24), (19, .local 28), (30, .local 29)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0040
