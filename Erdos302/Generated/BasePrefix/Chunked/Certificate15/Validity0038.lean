...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0038
...
def steps : Array (Step 47 146) := #[
  ...
  { claim := ⟨76274968806949073855, 6⟩, rule := .branch 3 [(4, .local 4), (8, .local 5), (2, .local 6)] },
  { claim := ⟨372575865859652924351, 7⟩, rule := .branch 46 [(16, .local 2), (20, .local 3), (28, .local 7)] },
  { claim := ⟨116057269705614334134285247, 8⟩, rule := .branch 14 [(8, .local 0), (9, .local 1), (26, .local 8)] },
  { claim := ⟨324521145595775021172438466786239, 9⟩, rule := .branch 54 [(19, .imported 12), (21, .imported 4), (36, .local 9)] },
  { claim := ⟨325239150969824131366674433799103, 10⟩, rule := .branch 58 [(22, .imported 3), (20, .imported 11), (33, .local 10)] },
  { claim := ⟨325239150969824131374375847293887, 11⟩, rule := .branch 42 [(20, .imported 9), (26, .imported 10), (15, .local 11)] },
  { claim := ⟨325239159432314092189554446922687, 12⟩, rule := .branch 47 [(21, .imported 7), (16, .imported 8), (25, .local 12)] },
  ...
  { claim := ⟨325239043390606035917878842399663, 10⟩, rule := .branch 59 [(23, .imported 6), (20, .local 14), (31, .local 15)] },
  { claim := ⟨325239159432282512132016761230223, 8⟩, rule := .packing [0, 2, 12, 48, 22, 8, 92, 80, 86] },
  { claim := ⟨325239159432283953283897521886127, 9⟩, rule := .branch 58 [(22, .imported 0), (33, .imported 1), (20, .local 17)] },
  { claim := ⟨325239159432282474695844858712463, 7⟩, rule := .packing [0, 2, 12, 8, 22, 92, 80, 86] },
  { claim := ⟨325239159432283915847725619368367, 8⟩, rule := .branch 58 [(33, .imported 5), (22, .imported 2), (20, .local 19)] },
  ...
  { claim := ⟨325239150983454061893842218571951, 7⟩, rule := .branch 15 [(23, .local 23), (8, .local 24), (10, .local 25)] },
  { claim := ⟨325239150983970858958282237729199, 8⟩, rule := .branch 58 [(33, .local 21), (20, .local 22), (22, .local 26)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0038
