...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0043
...
def steps : Array (Step 47 146) := #[
  ...
  { claim := ⟨325239077089263598556462242397083, 9⟩, rule := .branch 11 [(8, .local 0), (23, .imported 0), (7, .local 1)] },
  { claim := ⟨325239077073915902980233437934491, 7⟩, rule := .packing [1, 4, 12, 22, 48, 8, 92, 80] },
  { claim := ⟨325239077073917344202482942768059, 8⟩, rule := .branch 58 [(20, .local 3), (22, .imported 4), (33, .imported 5)] },
  { claim := ⟨325239038388143542585058210886587, 8⟩, rule := .packing [1, 40, 91, 20, 80, 33, 7, 50, 8] },
  { claim := ⟨325239077073917344210183819391931, 9⟩, rule := .branch 42 [(20, .imported 0), (15, .local 4), (26, .local 5)] },
  ...
  { claim := ⟨720523415490581396031756596155, 8⟩, rule := .branch 42 [(20, .local 9), (26, .local 10), (15, .local 11)] },
  { claim := ⟨720523421393544003218440518587, 9⟩, rule := .branch 11 [(8, .local 7), (7, .local 8), (23, .local 12)] },
  { claim := ⟨325239077089265616243862097165243, 10⟩, rule := .branch 59 [(20, .local 2), (23, .local 6), (31, .local 13)] },
  { claim := ⟨325239159447632297488432386866107, 11⟩, rule := .branch 56 [(23, .imported 6), (19, .imported 7), (30, .local 14)] },
  { claim := ⟨325239159447632297488434039552959, 12⟩, rule := .branch 30 [(23, .imported 1), (16, .imported 3), (12, .local 15)] },
  ...
  { claim := ⟨718125057557391270236719960719, 7⟩, rule := .branch 14 [(8, .local 18), (26, .local 19), (9, .local 20)] },
  { claim := ⟨718125057585061949297237774991, 8⟩, rule := .branch 64 [(26, .imported 2), (29, .local 17), (21, .local 21)] },
  ...
  { claim := ⟨84182492016968795712145134479, 7⟩, rule := .branch 50 [(19, .local 24), (37, .local 25), (18, .local 26)] },
  { claim := ⟨718009001059208954098885137295, 8⟩, rule := .branch 61 [(22, .imported 2), (21, .local 23), (38, .local 27)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate15.Validity0043
