...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate18.Validity0110
...
def imports : Array (Claim 146) := #[⟨786249001160110654327260189294996254693359, 10⟩, ⟨786249001160110673707869519807119474644943, 10⟩, ⟨802678259147090927852897361799895020033999, 10⟩, ⟨786249001160110673707870681740496262748143, 11⟩, ⟨786249001167736369805265781523832804545455, 10⟩, ⟨786249001167736369805265717066337378178539, 9⟩, ⟨786249001124279722666191727894079498163691, 8⟩, ⟨786249001124279722666190574972300011312587, 7⟩]
...
def steps : Array (Step 47 146) := #[
  ...
  { claim := ⟨786249001124279722666190594394073421125579, 8⟩, rule := .branch 54 [(19, .imported 7), (36, .local 0), (21, .local 1)] },
  { claim := ⟨88670148936336065525645235996329688504299, 8⟩, rule := .packing [136, 40, 1, 102, 74, 8, 21, 7, 26] },
  { claim := ⟨786249001124279722666191756323052162717675, 9⟩, rule := .branch 53 [(19, .imported 6), (20, .local 2), (43, .local 3)] },
  ...
  { claim := ⟨786249001167736369805265781524107061696491, 10⟩, rule := .branch 55 [(19, .imported 5), (31, .local 4), (22, .local 14)] },
  ...
  { claim := ⟨786249001167736466557128729305875224025071, 12⟩, rule := .branch 86 [(30, .imported 3), (26, .local 16), (37, .local 23)] },
  { claim := ⟨802423042220524711409089750697487843547087, 10⟩, rule := .packing [0, 2, 8, 24, 12, 16, 32, 74, 95, 123, 139] },
  { claim := ⟨802678259512530827449941654981112533178319, 11⟩, rule := .branch 108 [(38, .imported 1), (31, .imported 2), (36, .local 25)] },
  ...
  { claim := ⟨802678259152181284064209775116777841563599, 10⟩, rule := .branch 82 [(25, .local 27), (30, .local 28), (36, .local 29)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate18.Validity0110
