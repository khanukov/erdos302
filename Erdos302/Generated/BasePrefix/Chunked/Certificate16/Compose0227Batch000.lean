import Erdos302.Generated.BasePrefix.Chunked.Certificate16.Validity0227
...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate16.Compose0227Batch000
open Erdos302.BasePrefixCoverChunk
open Erdos302.Generated.BasePrefix
open Erdos302.Generated.BasePrefix.Chunked.Certificate16

def sources : List (Claim 146) := [Validity0069.steps[3].claim, Validity0069.steps[9].claim, Validity0143.steps[4].claim, Validity0225.steps[29].claim, Validity0226.steps[20].claim, Validity0226.steps[24].claim, Validity0226.steps[25].claim, Validity0226.steps[29].claim, Validity0226.steps[30].claim, Validity0226.steps[31].claim]
theorem sources_match : SliceEq Validity0227.imports sources 0 := by decide
theorem sources_hold : ClaimsHold sources support := by
  intro claim h
  simp only [sources, List.mem_cons, List.not_mem_nil, or_false] at h
  rcases h with rfl | h
  exact Compose0069Root.all_holds ⟨3, by decide⟩
  rcases h with rfl | h
  ...
  rcases h with rfl | h
  exact Compose0226Root.all_holds ⟨24, by decide⟩
  rcases h with rfl | h
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate16.Compose0227Batch000
