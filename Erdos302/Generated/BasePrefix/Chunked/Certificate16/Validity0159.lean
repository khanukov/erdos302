...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate16.Validity0159
...
def imports : Array (Claim 146) := #[⟨325239043375256217742161502024091, 7⟩, ⟨324521071850983961460075622593282, 6⟩, ⟨325239159431765965865092377768091, 7⟩, ⟨324521154058233652735296429912475, 7⟩, ⟨324521154058233690206652704519067, 8⟩, ⟨325239159432282512170512519820187, 9⟩, ⟨325239159431767120303923033043643, 9⟩]
...
def steps : Array (Step 47 146) := #[
  ...
  { claim := ⟨324521154058234843089661518152619, 6⟩, rule := .branch 68 [(22, .local 0), (28, .local 1), (30, .local 2)] },
  ...
  { claim := ⟨324521154058234843089661521318827, 7⟩, rule := .branch 14 [(9, .local 3), (8, .local 4), (26, .local 5)] },
  ...
  { claim := ⟨324521071850983961460075622593467, 7⟩, rule := .branch 7 [(4, .imported 1), (7, .local 8), (10, .local 9)] },
  { claim := ⟨324521154058234843195223227528123, 8⟩, rule := .branch 45 [(16, .local 6), (19, .local 7), (30, .local 10)] },
  ...
  { claim := ⟨324521036792134039682439112307643, 7⟩, rule := .branch 7 [(4, .local 14), (7, .local 15), (10, .local 16)] },
  { claim := ⟨324521038001356160194120990864315, 8⟩, rule := .branch 46 [(16, .local 12), (20, .local 13), (28, .local 17)] },
  { claim := ⟨324521154058234843202924104151995, 9⟩, rule := .branch 42 [(15, .local 11), (20, .imported 4), (26, .local 18)] },
  { claim := ⟨325239159432283953397160071164859, 10⟩, rule := .branch 58 [(20, .imported 5), (22, .imported 6), (33, .local 19)] },
  { claim := ⟨325239159447630170272082219250065, 8⟩, rule := .packing [0, 8, 13, 20, 40, 77, 52, 80, 91] },
  { claim := ⟨325239159432282474699156245213595, 8⟩, rule := .branch 67 [(26, .imported 0), (33, .imported 3), (22, .imported 2)] },
  ...
  { claim := ⟨325239159431765965865092377755675, 6⟩, rule := .branch 85 [(26, .local 25), (29, .local 26), (38, .local 27)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate16.Validity0159
