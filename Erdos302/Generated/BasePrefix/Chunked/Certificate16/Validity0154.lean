...
namespace Erdos302.Generated.BasePrefix.Chunked.Certificate16.Validity0154
...
def imports : Array (Claim 146) := #[⟨86740579218753210689411699631, 9⟩, ⟨325239150969285229970054985306767, 7⟩, ⟨325239159432283953291598935380911, 10⟩, ⟨325239159431794953007009000411823, 10⟩, ⟨86663207800277181057916539823, 9⟩, ⟨86663207798836029177155883919, 8⟩, ⟨86658220841479538283283567503, 8⟩]

def steps : Array (Step 47 146) := #[
  { claim := ⟨7432627525165056798198420367, 8⟩, rule := .packing [0, 2, 8, 12, 18, 22, 48, 64, 77] },
  { claim := ⟨86740579217312062112018027407, 9⟩, rule := .branch 86 [(26, .imported 5), (30, .imported 6), (37, .local 0)] },
  { claim := ⟨86740579218753218390825194415, 10⟩, rule := .branch 42 [(15, .imported 0), (26, .imported 4), (20, .local 1)] },
  { claim := ⟨325239159432314091943255252226991, 11⟩, rule := .branch 61 [(21, .imported 2), (22, .imported 3), (38, .local 2)] },
  ...
  { claim := ⟨325239150969303675869712354865311, 8⟩, rule := .branch 14 [(8, .local 4), (26, .local 5), (9, .local 6)] },
  ...
  { claim := ⟨325239150969285230005247410467483, 7⟩, rule := .branch 7 [(4, .local 9), (7, .local 10), (10, .local 11)] },
  { claim := ⟨325239150969285230005247947469471, 8⟩, rule := .branch 17 [(8, .local 8), (16, .imported 1), (12, .local 12)] },
  ...
  { claim := ⟨718121430798379768565787013781, 7⟩, rule := .branch 45 [(16, .local 14), (19, .local 15), (30, .local 16)] },
  ...
  { claim := ⟨718121430798379768565787488927, 8⟩, rule := .branch 14 [(8, .local 17), (26, .local 18), (9, .local 19)] },
  { claim := ⟨325239150969303695326670119989919, 9⟩, rule := .branch 54 [(19, .local 7), (21, .local 13), (36, .local 20)] },
...
end Erdos302.Generated.BasePrefix.Chunked.Certificate16.Validity0154
