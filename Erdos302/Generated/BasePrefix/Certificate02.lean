...
namespace Erdos302.Generated.BasePrefix.Certificate02

open Erdos302.BasePrefixCover
open Erdos302.Generated.BasePrefix

def certificate : Array (Node 47 146) := #[
  { mask := 1231, budget := 2, rule := .packing [2, 10, 0].toFinset }
]
...
theorem root_semantics :
    activeEdges certificate[root].mask = prefixEdges 24 ∧
    certificate[root].budget + 1 = 3 := by decide

theorem demand_valid : PrefixDemand 24 3 := by
  intro cover hcover
...
end Erdos302.Generated.BasePrefix.Certificate02
