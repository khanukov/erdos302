...
namespace Erdos302.Generated.BasePrefix.Certificate04

open Erdos302.BasePrefixCover
open Erdos302.Generated.BasePrefix

def certificate : Array (Node 47 146) := #[
  { mask := 17184479, budget := 4, rule := .packing [12, 24, 0, 2, 18].toFinset }
]
...
theorem root_semantics :
    activeEdges certificate[root].mask = prefixEdges 40 ∧
    certificate[root].budget + 1 = 5 := by decide

theorem demand_valid : PrefixDemand 40 5 := by
  intro cover hcover
...
end Erdos302.Generated.BasePrefix.Certificate04
