...
def packingCertificateNat192VertexGroup76 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat192VertexGroup79 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13114, snapshot := { maximum := 509, demand := 20, support := [49, 62, 74, 84, 90, 98, 105, 118, 127, 136, 141, 145, 160, 162, 170, 181, 186, 190, 196, 207, 209, 220, 232, 238, 248, 260, 263, 274, 282, 289, 294, 306, 317, 321, 339, 346, 352, 363, 380, 398, 409, 422, 437, 455, 478, 509] },
    numerator := 2893000, denominator := 8682679, units := 0 },
  { configurationId := 13237, snapshot := { maximum := 513, demand := 17, support := [106, 130, 147, 162, 173, 184, 193, 209, 224, 235, 241, 245, 263, 267, 279, 292, 297, 302, 311, 321, 325, 336, 350, 356, 368, 380, 384, 395, 403, 407, 414, 426, 437, 442, 460, 464, 471, 483, 496, 513] },
    numerator := 2893000, denominator := 8682679, units := 0 },
...
def packingCertificateNat192VertexChunk19 : List Erdos302.PackingTermNat :=
  packingCertificateNat192VertexGroup76 ++ packingCertificateNat192VertexGroup77 ++ packingCertificateNat192VertexGroup78 ++ packingCertificateNat192VertexGroup79
