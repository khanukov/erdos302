...
def packingCertificateNat115VertexGroup52 : List Erdos302.PackingTermNat := [
  { configurationId := 3703, snapshot := { maximum := 309, demand := 1, support := [242, 290, 309] },
    numerator := 10817436500, denominator := 22067736049, units := 0 },
  { configurationId := 3756, snapshot := { maximum := 308, demand := 1, support := [243, 293, 308] },
    numerator := 2909335000, denominator := 11272009061, units := 0 },
...
def packingCertificateNat115VertexGroup53 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 12713, snapshot := { maximum := 303, demand := 18, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303] },
    numerator := 6210107800, denominator := 6826709713, units := 0 },
...
def packingCertificateNat115VertexGroup54 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat115VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat115VertexGroup52 ++ packingCertificateNat115VertexGroup53 ++ packingCertificateNat115VertexGroup54
