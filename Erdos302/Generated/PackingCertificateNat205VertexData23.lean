...
def packingCertificateNat205VertexGroup92 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat205VertexGroup93 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13577, snapshot := { maximum := 552, demand := 21, support := [47, 59, 71, 80, 88, 94, 102, 113, 123, 132, 136, 140, 154, 157, 166, 176, 181, 185, 191, 202, 205, 214, 226, 232, 243, 254, 258, 268, 276, 281, 289, 300, 312, 315, 334, 338, 346, 358, 372, 393, 404, 416, 429, 451, 473, 504, 552] },
    numerator := 8327, denominator := 133235, units := 0 },
...
def packingCertificateNat205VertexGroup94 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat205VertexChunk23 : List Erdos302.PackingTermNat :=
  packingCertificateNat205VertexGroup92 ++ packingCertificateNat205VertexGroup93 ++ packingCertificateNat205VertexGroup94
