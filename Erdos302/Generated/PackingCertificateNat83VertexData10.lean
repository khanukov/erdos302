...
def packingCertificateNat83VertexGroup40 : List Erdos302.PackingTermNat := [
  { configurationId := 12691, snapshot := { maximum := 113, demand := 17, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113] },
    numerator := 5926200, denominator := 92528111, units := 0 },
  { configurationId := 12692, snapshot := { maximum := 129, demand := 18, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113, 120, 129] },
    numerator := 248900400, denominator := 633461683, units := 0 },
...
def packingCertificateNat83VertexGroup41 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat83VertexChunk10 : List Erdos302.PackingTermNat :=
  packingCertificateNat83VertexGroup40 ++ packingCertificateNat83VertexGroup41
