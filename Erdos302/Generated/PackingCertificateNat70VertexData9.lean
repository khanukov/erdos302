...
def packingCertificateNat70VertexGroup36 : List Erdos302.PackingTermNat := [
  { configurationId := 1916, snapshot := { maximum := 199, demand := 1, support := [148, 191, 199] },
    numerator := 110580177438, denominator := 214950236255, units := 0 },
  { configurationId := 1934, snapshot := { maximum := 194, demand := 1, support := [147, 192, 194] },
    numerator := 13383175509, denominator := 81924429667, units := 0 },
  { configurationId := 12691, snapshot := { maximum := 113, demand := 17, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113] },
    numerator := 67321428318, denominator := 709741346125, units := 0 },
  { configurationId := 12692, snapshot := { maximum := 129, demand := 18, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113, 120, 129] },
    numerator := 54073436400, denominator := 145192801093, units := 0 },
...
def packingCertificateNat70VertexGroup37 : List Erdos302.PackingTermNat := [
  { configurationId := 12730, snapshot := { maximum := 195, demand := 14, support := [11, 16, 21, 25, 28, 32, 36, 41, 47, 51, 54, 57, 63, 65, 71, 77, 80, 83, 87, 92, 94, 102, 109, 113, 121, 129, 132, 140, 146, 149, 154, 164, 172, 176, 191, 195] },
    numerator := 20728150620, denominator := 83546695601, units := 0 },
  ...
  { configurationId := 13022, snapshot := { maximum := 181, demand := 12, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181] },
    numerator := 53127151263, denominator := 298496931856, units := 0 },
]

def packingCertificateNat70VertexChunk9 : List Erdos302.PackingTermNat :=
  packingCertificateNat70VertexGroup36 ++ packingCertificateNat70VertexGroup37
