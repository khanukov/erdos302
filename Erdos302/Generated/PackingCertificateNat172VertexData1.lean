...
def packingCertificateNat172VertexGroup4 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat172VertexGroup5 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat172VertexGroup6 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat172VertexGroup7 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 109, snapshot := { maximum := 226, demand := 1, support := [31, 32, 226] },
    numerator := 10740065, denominator := 147736756, units := 0 },
  { configurationId := 112, snapshot := { maximum := 118, demand := 1, support := [30, 33, 118] },
    numerator := 6619387, denominator := 17206729, units := 0 },
  { configurationId := 114, snapshot := { maximum := 229, demand := 1, support := [32, 33, 229] },
    numerator := 38357375, denominator := 114200074, units := 0 },
]

def packingCertificateNat172VertexChunk1 : List Erdos302.PackingTermNat :=
  packingCertificateNat172VertexGroup4 ++ packingCertificateNat172VertexGroup5 ++ packingCertificateNat172VertexGroup6 ++ packingCertificateNat172VertexGroup7
