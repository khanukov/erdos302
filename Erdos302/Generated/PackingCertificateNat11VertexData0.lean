...
def packingCertificateNat11VertexGroup0 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat11VertexGroup1 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat11VertexGroup2 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat11VertexGroup3 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 164, snapshot := { maximum := 49, demand := 1, support := [27, 42, 49] },
    numerator := 3, denominator := 4, units := 0 },
  { configurationId := 12760, snapshot := { maximum := 37, demand := 2, support := [8, 12, 15, 19, 22, 25, 27, 33, 37] },
    numerator := 1, denominator := 4, units := 0 },
]

def packingCertificateNat11VertexChunk0 : List Erdos302.PackingTermNat :=
  packingCertificateNat11VertexGroup0 ++ packingCertificateNat11VertexGroup1 ++ packingCertificateNat11VertexGroup2 ++ packingCertificateNat11VertexGroup3
