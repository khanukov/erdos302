...
def packingCertificateNat119VertexGroup52 : List Erdos302.PackingTermNat := [
  { configurationId := 4147, snapshot := { maximum := 319, demand := 1, support := [257, 312, 319] },
    numerator := 85525606, denominator := 104123987, units := 0 },
  { configurationId := 4215, snapshot := { maximum := 318, demand := 1, support := [260, 315, 318] },
    numerator := 9772203925, denominator := 14709879618, units := 0 },
  ...
  { configurationId := 12713, snapshot := { maximum := 303, demand := 18, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303] },
    numerator := 26169630850, denominator := 27630719823, units := 0 },
...
def packingCertificateNat119VertexGroup53 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 12877, snapshot := { maximum := 319, demand := 14, support := [40, 52, 61, 70, 78, 85, 89, 101, 110, 119, 122, 125, 139, 142, 150, 161, 165, 168, 175, 183, 187, 197, 208, 213, 225, 234, 239, 249, 256, 262, 266, 280, 291, 295, 313, 319] },
    numerator := 1457549060, denominator := 27630719823, units := 0 },
  ...
  { configurationId := 13028, snapshot := { maximum := 289, demand := 18, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181, 190, 193, 209, 214, 220, 232, 245, 263, 274, 289] },
    numerator := 40612616990, denominator := 57183000497, units := 0 },
...
def packingCertificateNat119VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat119VertexGroup52 ++ packingCertificateNat119VertexGroup53
