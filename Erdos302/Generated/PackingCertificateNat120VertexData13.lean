...
def packingCertificateNat120VertexGroup52 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 4215, snapshot := { maximum := 318, demand := 1, support := [260, 315, 318] },
    numerator := 1327700, denominator := 7289433, units := 0 },
...
def packingCertificateNat120VertexGroup53 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat120VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat120VertexGroup52 ++ packingCertificateNat120VertexGroup53
