...
def packingCertificateNat117VertexGroup52 : List Erdos302.PackingTermNat := [
  { configurationId := 3738, snapshot := { maximum := 311, demand := 1, support := [243, 292, 311] },
    numerator := 84146855832, denominator := 329998349527, units := 0 },
  { configurationId := 3756, snapshot := { maximum := 308, demand := 1, support := [243, 293, 308] },
    numerator := 149834145, denominator := 12077861671, units := 0 },
  { configurationId := 3757, snapshot := { maximum := 311, demand := 1, support := [244, 293, 311] },
    numerator := 31295358419, denominator := 112596839449, units := 0 },
  { configurationId := 3819, snapshot := { maximum := 317, demand := 1, support := [248, 296, 317] },
    numerator := 5064394101, denominator := 264933739880, units := 0 },
  { configurationId := 3836, snapshot := { maximum := 304, demand := 1, support := [244, 297, 304] },
    numerator := 11167638274, denominator := 19090813609, units := 0 },
]

def packingCertificateNat117VertexGroup53 : List Erdos302.PackingTermNat := [
  { configurationId := 3856, snapshot := { maximum := 314, demand := 1, support := [249, 298, 314] },
    numerator := 107563339, denominator := 389608441, units := 0 },
  { configurationId := 3857, snapshot := { maximum := 317, demand := 1, support := [250, 298, 317] },
    numerator := 263429334, denominator := 389608441, units := 0 },
  ...
  { configurationId := 3877, snapshot := { maximum := 313, demand := 1, support := [248, 299, 313] },
    numerator := 43631703024, denominator := 371296844273, units := 0 },
  { configurationId := 3898, snapshot := { maximum := 312, demand := 1, support := [247, 300, 312] },
    numerator := 4255289718, denominator := 21428464255, units := 0 },
]

def packingCertificateNat117VertexGroup54 : List Erdos302.PackingTermNat := [
  { configurationId := 3924, snapshot := { maximum := 316, demand := 1, support := [252, 301, 316] },
    numerator := 41813715398, denominator := 120389008269, units := 0 },
  ...
  { configurationId := 12713, snapshot := { maximum := 303, demand := 18, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303] },
    numerator := 261400649367, denominator := 272725908700, units := 0 },
...
def packingCertificateNat117VertexGroup55 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13193, snapshot := { maximum := 309, demand := 15, support := [34, 46, 55, 62, 69, 75, 81, 90, 100, 106, 112, 114, 127, 130, 138, 147, 152, 155, 162, 170, 173, 182, 193, 200, 209, 220, 224, 233, 241, 245, 252, 263, 274, 279, 297, 302, 309] },
    numerator := 10128788202, denominator := 33116717485, units := 0 },
]

def packingCertificateNat117VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat117VertexGroup52 ++ packingCertificateNat117VertexGroup53 ++ packingCertificateNat117VertexGroup54 ++ packingCertificateNat117VertexGroup55
