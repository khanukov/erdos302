...
def packingCertificateNat240VertexGroup92 : List Erdos302.PackingTermNat := [
  { configurationId := 11352, snapshot := { maximum := 632, demand := 1, support := [595, 628, 632] },
    numerator := 27187144900, denominator := 628300269921, units := 0 },
  { configurationId := 11376, snapshot := { maximum := 640, demand := 1, support := [600, 629, 640] },
    numerator := 59701500625, denominator := 363752787849, units := 0 },
  { configurationId := 11516, snapshot := { maximum := 644, demand := 1, support := [608, 636, 644] },
    numerator := 1796555926500, denominator := 9468595295827, units := 0 },
  { configurationId := 11707, snapshot := { maximum := 648, demand := 1, support := [616, 646, 648] },
    numerator := 184615409625, denominator := 1664444574703, units := 0 },
...
def packingCertificateNat240VertexGroup93 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat240VertexGroup94 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 13241, snapshot := { maximum := 635, demand := 21, support := [106, 130, 147, 162, 173, 184, 193, 209, 224, 235, 241, 245, 263, 267, 279, 292, 297, 302, 311, 321, 325, 336, 350, 356, 368, 380, 384, 395, 403, 407, 414, 426, 437, 442, 460, 464, 471, 483, 496, 513, 523, 534, 546, 561, 578, 602, 635] },
    numerator := 5510907750, denominator := 11022811753, units := 0 },
  { configurationId := 14144, snapshot := { maximum := 642, demand := 21, support := [115, 139, 156, 171, 183, 194, 204, 221, 234, 246, 253, 257, 275, 280, 291, 303, 310, 314, 322, 333, 337, 349, 361, 367, 381, 392, 396, 406, 415, 420, 425, 438, 450, 454, 472, 476, 482, 493, 508, 524, 533, 544, 555, 570, 587, 611, 642] },
    numerator := 2755453875, denominator := 22045623506, units := 0 },
...
def packingCertificateNat240VertexGroup95 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat240VertexChunk23 : List Erdos302.PackingTermNat :=
  packingCertificateNat240VertexGroup92 ++ packingCertificateNat240VertexGroup93 ++ packingCertificateNat240VertexGroup94 ++ packingCertificateNat240VertexGroup95
