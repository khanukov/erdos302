...
def packingCertificateNat219VertexGroup88 : List Erdos302.PackingTermNat := [
  ...
  { configurationId := 10477, snapshot := { maximum := 590, demand := 1, support := [546, 588, 590] },
    numerator := 126181125, denominator := 238086056, units := 0 },
...
def packingCertificateNat219VertexGroup89 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat219VertexGroup90 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat219VertexGroup91 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat219VertexChunk22 : List Erdos302.PackingTermNat :=
  packingCertificateNat219VertexGroup88 ++ packingCertificateNat219VertexGroup89 ++ packingCertificateNat219VertexGroup90 ++ packingCertificateNat219VertexGroup91
