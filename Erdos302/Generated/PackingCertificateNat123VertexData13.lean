...
def packingCertificateNat123VertexGroup52 : List Erdos302.PackingTermNat := [
  { configurationId := 3926, snapshot := { maximum := 329, demand := 1, support := [256, 301, 329] },
    numerator := 1715067448500, denominator := 3450399949639, units := 0 },
  { configurationId := 3950, snapshot := { maximum := 326, demand := 1, support := [255, 302, 326] },
    numerator := 771059735250, denominator := 2200951499909, units := 0 },
  ...
  { configurationId := 3994, snapshot := { maximum := 329, demand := 1, support := [259, 304, 329] },
    numerator := 1767912664000, denominator := 7679302394879, units := 0 },
  { configurationId := 4019, snapshot := { maximum := 334, demand := 1, support := [261, 306, 334] },
    numerator := 1835170211000, denominator := 3642622788059, units := 0 },
]

def packingCertificateNat123VertexGroup53 : List Erdos302.PackingTermNat := [
  { configurationId := 4106, snapshot := { maximum := 324, demand := 1, support := [260, 310, 324] },
    numerator := 4275658345000, denominator := 8736528006189, units := 0 },
  ...
  { configurationId := 4215, snapshot := { maximum := 318, demand := 1, support := [260, 315, 318] },
    numerator := 544923391000, denominator := 1278281875493, units := 0 },
  { configurationId := 4257, snapshot := { maximum := 333, demand := 1, support := [266, 317, 333] },
    numerator := 178328581760, denominator := 221056264183, units := 0 },
  { configurationId := 4277, snapshot := { maximum := 327, demand := 1, support := [264, 318, 327] },
    numerator := 1758304443000, denominator := 4622959264001, units := 0 },
]

def packingCertificateNat123VertexGroup54 : List Erdos302.PackingTermNat := [
  { configurationId := 4337, snapshot := { maximum := 332, demand := 1, support := [268, 321, 332] },
    numerator := 2805600532000, denominator := 7986858936351, units := 0 },
  ...
  { configurationId := 12695, snapshot := { maximum := 254, demand := 21, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113, 120, 129, 140, 154, 172, 202, 254] },
    numerator := 46668502000, denominator := 105722561131, units := 0 },
  { configurationId := 12713, snapshot := { maximum := 303, demand := 18, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303] },
    numerator := 104317828000, denominator := 105722561131, units := 0 },
...
def packingCertificateNat123VertexGroup55 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat123VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat123VertexGroup52 ++ packingCertificateNat123VertexGroup53 ++ packingCertificateNat123VertexGroup54 ++ packingCertificateNat123VertexGroup55
