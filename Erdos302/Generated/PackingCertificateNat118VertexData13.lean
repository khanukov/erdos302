...
def packingCertificateNat118VertexGroup52 : List Erdos302.PackingTermNat := [
  { configurationId := 4215, snapshot := { maximum := 318, demand := 1, support := [260, 315, 318] },
    numerator := 1529250800, denominator := 4877500811, units := 0 },
  ...
  { configurationId := 12713, snapshot := { maximum := 303, demand := 18, support := [17, 24, 29, 35, 40, 44, 48, 56, 61, 67, 70, 73, 82, 85, 89, 97, 101, 104, 108, 115, 119, 125, 135, 139, 148, 156, 161, 168, 175, 180, 183, 194, 204, 208, 225, 230, 234, 246, 262, 280, 291, 303] },
    numerator := 5278504, denominator := 5461927, units := 0 },
...
def packingCertificateNat118VertexGroup53 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat118VertexChunk13 : List Erdos302.PackingTermNat :=
  packingCertificateNat118VertexGroup52 ++ packingCertificateNat118VertexGroup53
