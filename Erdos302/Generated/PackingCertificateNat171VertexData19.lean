...
def packingCertificateNat171VertexGroup76 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat171VertexGroup77 : List Erdos302.PackingTermNat := [
  { configurationId := 13031, snapshot := { maximum := 437, demand := 21, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181, 190, 193, 209, 214, 220, 232, 245, 263, 274, 289, 302, 321, 346, 380, 437] },
    numerator := 832903, denominator := 3835895, units := 0 },
  { configurationId := 13048, snapshot := { maximum := 463, demand := 17, support := [78, 95, 110, 122, 133, 142, 150, 165, 177, 187, 192, 197, 213, 216, 227, 239, 244, 249, 256, 266, 270, 283, 295, 301, 313, 324, 329, 340, 348, 354, 359, 371, 383, 387, 405, 411, 417, 428, 446, 463] },
    numerator := 219185, denominator := 219194, units := 0 },
  ...
  { configurationId := 13196, snapshot := { maximum := 380, demand := 18, support := [34, 46, 55, 62, 69, 75, 81, 90, 100, 106, 112, 114, 127, 130, 138, 147, 152, 155, 162, 170, 173, 182, 193, 200, 209, 220, 224, 233, 241, 245, 252, 263, 274, 279, 297, 302, 309, 321, 336, 356, 366, 380] },
    numerator := 10301695, denominator := 89650346, units := 0 },
]

def packingCertificateNat171VertexGroup78 : List Erdos302.PackingTermNat := [
...
def packingCertificateNat171VertexChunk19 : List Erdos302.PackingTermNat :=
  packingCertificateNat171VertexGroup76 ++ packingCertificateNat171VertexGroup77 ++ packingCertificateNat171VertexGroup78
