...
def packingCertificateNat71VertexGroup36 : List Erdos302.PackingTermNat := [
  { configurationId := 1917, snapshot := { maximum := 202, demand := 1, support := [149, 191, 202] },
    numerator := 724418695, denominator := 26912578958, units := 0 },
  { configurationId := 12691, snapshot := { maximum := 113, demand := 17, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113] },
    numerator := 434651217, denominator := 119386083776, units := 0 },
  { configurationId := 12692, snapshot := { maximum := 129, demand := 18, support := [0, 1, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13, 15, 16, 18, 21, 22, 23, 25, 27, 28, 31, 36, 37, 41, 45, 47, 50, 54, 57, 58, 63, 68, 71, 80, 83, 86, 92, 102, 113, 120, 129] },
    numerator := 585834249, denominator := 1666189276, units := 0 },
...
def packingCertificateNat71VertexGroup37 : List Erdos302.PackingTermNat := [
  { configurationId := 12731, snapshot := { maximum := 202, demand := 15, support := [11, 16, 21, 25, 28, 32, 36, 41, 47, 51, 54, 57, 63, 65, 71, 77, 80, 83, 87, 92, 94, 102, 109, 113, 121, 129, 132, 140, 146, 149, 154, 164, 172, 176, 191, 195, 202] },
    numerator := 836586751, denominator := 2463062408, units := 0 },
  { configurationId := 12774, snapshot := { maximum := 202, demand := 16, support := [8, 12, 15, 19, 22, 25, 27, 33, 37, 41, 43, 45, 53, 54, 58, 63, 66, 68, 72, 79, 80, 86, 92, 96, 103, 111, 113, 120, 124, 129, 134, 143, 151, 154, 167, 172, 178, 188, 202] },
    numerator := 11354525, denominator := 108664518, units := 0 },
  ...
  { configurationId := 13022, snapshot := { maximum := 181, demand := 12, support := [14, 20, 26, 30, 34, 38, 42, 49, 55, 59, 62, 64, 74, 75, 81, 88, 90, 93, 98, 105, 106, 114, 123, 127, 136, 145, 147, 155, 162, 166, 170, 181] },
    numerator := 14633257639, denominator := 137207064728, units := 0 },
]

def packingCertificateNat71VertexChunk9 : List Erdos302.PackingTermNat :=
  packingCertificateNat71VertexGroup36 ++ packingCertificateNat71VertexGroup37
