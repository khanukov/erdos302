...
example : Erdos302.Array.CellBlockEq
  ...
  clear hget
  interval_cases i <;>
  simp [Erdos302.PackingTerm.raw, packingCertificate270Chunk0,
    concreteConfigurationAt, concreteConfigurationGroup0,
    configurationChunk0, configurationChunk1, configurationChunk2,
    configurationChunk3, configurationChunk4, configurationChunk5,
    configurationChunk6, configurationChunk7] <;>
