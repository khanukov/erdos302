...
observed by Cambie \cite{Cambie302}.  Van Doorn obtained
\[
 f(N)\leq(9/10+o(1))N
\]
using disjoint multiplicative dilates \cite{VanDoorn302}.  A previous publicly
available anonymous partial proof posted in July 2026
\cite{Partial302Pastebin2026} refined the same architecture to
\[
...
unrefereed.  A root-project build alone does not establish the lower statement.
