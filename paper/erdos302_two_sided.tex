...
\cite{Cambie302,VanDoorn302}.  The present work improves both sides; it does
not prove that $f(N)/N$ converges.
...
\texttt{21a503880a3feef06203c58a30fbbd8322033ef8}, the separate lower project
built from the exact pins and reproduced its committed transitive axiom report
in GitHub Actions run
\href{https://github.com/khanukov/erdos302/actions/runs/31895648228}{31895648228}.
A root-project build alone does not establish the lower statement.  At the
pinned revisions, the external repositories have no license file, so their
