...
\[
  ...
  =0.8718584656\ldots .
\]
The finite lemma is checked by a dependency-free exhaustive verifier and is
independently cross-checked by a mixed-integer linear program.  The later
source-closed Lean 4 development in this repository checks the finite
certificates, semantic bridge, omission argument, and asymptotic endpoint end
to end.
\end{abstract}
